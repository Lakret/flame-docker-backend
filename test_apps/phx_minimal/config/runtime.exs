...
#
#     PHX_SERVER=true bin/phx_minimal start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/phx_minimal/phx_minimal.db
      """

  config :phx_minimal, PhxMinimal.Repo,
  ...
  config :phx_minimal, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
